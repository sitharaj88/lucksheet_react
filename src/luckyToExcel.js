...
export function luckyToExcel(luckysheet, name) {
  ...
  tableArr.forEach(function (table) {
    ...
    setStyleAndValue(table.data, worksheet, luckysheet);
...
var setStyleAndValue = function (cellArr, worksheet, luckysheet) {
